                    ...
                    <ul class="glide__slides glide__hero">
                        ...
                        <li class="glide__slide">
                            <div class="banner">
                                ...
                                <img src="<?php base_url() ?>assets/Frontend/images/banner_1.png" class="special_01"
                                    alt="">
                        </li>
                        ...
                        <li class="glide__slide">
                            <div class="banner banner1">
                                ...
                                <img src="<?php base_url() ?>assets/Frontend/images/banner_2.png" class="special_02"
                                    alt="">
                            </div>
                        </li>
                        ...
                        <li class="glide__slide">
                            <div class="banner">
                                ...
                                <img src="<?php base_url() ?>assets/Frontend/images/banner_3.png" class="special_03"
                                    alt="">
                            </div>
                        </li>

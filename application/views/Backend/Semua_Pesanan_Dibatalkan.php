        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Pesanan Dibatalkan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                $no = 1;
                                foreach ($pesanan_dibatalkan as $pesanan) {
                                ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <a
                                                    href=" <?= base_url('Admin/Pesanan/tampil_detail_pesanan_dibatalkan/' . $pesanan['id_order']) ?>"><button

                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="idp"
                                                placeholder="Enter email" disabled value="<?php echo $u->id_produk ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="desk"
                                                placeholder="Enter email" disabled value="<?php echo $u->deskripsi ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="statusPromo"
                                                placeholder="Enter email" disabled
                                                value="<?php echo $u->status_promo ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Harga</label>
                                            <input type="Number" class="form-control" name="harga"
                                                placeholder="Enter email" disabled value="<?php echo $u->harga ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Harga Diskon</label>
                                            <input type="number" min="1" max="<?php echo $u->harga ?>"
                                                class="form-control" name="hargaDiskon"

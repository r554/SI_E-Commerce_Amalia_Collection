                    ...
                    <div class="row">
                        <div class="col-md-2 ">
                            <div class="info-box bg-danger">
                                ...
                                <div class="info-box-content text-dark">
                                    ...
                                    <a href="<?php echo base_url('Admin/Pesanan/tampil_semua_pesanan') ?>" class="small-box-footer text-light">
                        ...
                        <div class="col-md-2 col-sm-6 col-12">
                            <div class="info-box bg-warning">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <a href="<?php echo base_url('Admin/Pesanan/tampil_semua_pesanan_selesai') ?>" class="small-box-footer text-light">
                                        More info <i class="fas fa-arrow-circle-right"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="info-box mb-3 bg-success ">
                                ...
                                <div class="info-box-content text-dark">
                                    ...
                                    <a href="<?php echo base_url('data_produk/tampil') ?>" class="small-box-footer text-light">
                        ...
                        <div class="col-md-2">
                            <div class="info-box mb-3 bg-info">
                                ...
                                <div class="info-box-content text-dark">
                                    ...
                                    <a href="<?php echo base_url('Admin/data_customer/tampil') ?>" class="small-box-footer text-light">
                                        info <i class="fas fa-arrow-circle-right"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="info-box mb-3 bg-primary">
                                ...
                                <div class="info-box-content text-dark">
                                    ...
                                    <a href="<?php echo base_url('Admin/data_karyawan/tampil') ?>" class="small-box-footer text-light">
                                        info <i class="fas fa-arrow-circle-right"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-light">
                                    <table id="pesanan2" class="table table-bordered table-striped bg-light text-center">
                                        <thead>
                                            <tr>
                                                <th>NO</th>
                                                <th>ID Pemesanan</th>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body  bg-light">
                                    <table id="stok2" class="table table-bordered table-striped bg-light text-center" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID Produk</th>

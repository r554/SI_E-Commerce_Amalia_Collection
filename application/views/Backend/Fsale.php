  ...
  <!-- alert -->
    ...
    <section class="content">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-warning btn-sm" <?php echo anchor('Flashsale/detailProduk/'.$u->id_produk,'Edit'); ?></a>
                    <a class="btn btn-info btn-sm" <?php echo anchor('Flashsale/detailProduk/'.$u->id_produk,'Detail'); ?></a>
                    </td>
                    <td>
                    <a class="btn btn-success btn-sm" <?php echo anchor('Flashsale/updatestatus2/'.$u->id_produk,'Promo'); ?></a>
                    <a class="btn btn-danger btn-sm" <?php echo anchor('Flashsale/updatestatus3/'.$u->id_produk,'Tidak Promo'); ?></a>
                    </td>   
                  </tr>
                  <?php }}else { ?>
      ...
      <div class="card card-warning">
            ...
            <div>
            <form role="form" action="<?php echo base_url(). 'flashsale/tambah_aksiFS'; ?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="namaPromo">Nama Promo</label>
                    <input type="hidden" class="form-control" id="status" name="status_promo" value="0">
                    <input type="text" class="form-control" id="nama" name="nama_promo" placeholder="Masukan Nama Promo" required>
                  </div>
                  <div class="form-group">
                    <label for="durasi">Durasi Promo</label>
                    <input type="date" class="form-control" id="fasilitas" name="durasi_promo" placeholder="Tanggal Berakhir Promo" required>
                  </div>            

        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Detail Pengiriman Refund Produk<a href="<?php echo base_url('Admin/Pengembalian_Barang/tampil_refund_baru') ?>"> <button class="btn btn-info btn-sm rounded-pill"><span class="fa fa-arrow-left"></span>
                                        kembali </button></a></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Detail Refund Dikirim</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    <!-- Ini Bagian Konten -->
                    <?php if (!empty($data_detail_refund_baru['0']->no_resi)) { ?>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-1"></div>
                                            <div class="col-5">
                                                <h5>Produk Telah Dikirim Dengan No Resi <b><?= $data_detail_refund_baru['0']->no_resi ?></b></h5>
                                            </div>
                                            <div class="col-3"> <a href="<?= base_url('Admin/Pengembalian_Barang/terima_produk/' . $data_detail_refund_baru['0']->id_refund) ?>"><button class="btn btn-primary btn-sm">Produk Diterima</button></a></div>
                                            <div class="col-3"></div>
                                        </div>
                                    </div>
                                </div>

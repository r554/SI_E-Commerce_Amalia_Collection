        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Detail Pengiriman Refund Produk<a href="<?php echo base_url('Admin/Pengembalian_Barang/tampil_refund_diproses') ?>"> <button class="btn btn-info btn-sm rounded-pill"><span class="fa fa-arrow-left"></span>
                                        kembali </button></a></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-1"></div>
                                        <div class="col-5">
                                            <h5>Produk Telah Dikirim Dengan No Resi <b><?= $data_detail_refund_baru['0']->nomor_resi_admin ?></b></h5>
                                        </div>
                                        <div class="col-3"></div>
                                        <div class="col-3"></div>
                                    </div>
